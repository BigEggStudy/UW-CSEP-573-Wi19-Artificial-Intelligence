    ...
    def elapseTime(self, gameState):
        ...
        for ghost_position in self.allPositions:
            ...
            for new_ghost_position, probability in new_position_distribution.items():
                possible_beliefs[new_ghost_position] += self.beliefs[ghost_position] * probability
...
class ParticleFilter(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for ghost_position in self.allPositions:
            probability = self.getObservationProb(noisy_distance, pacman_position, ghost_position, self.getJailPosition())
            possible_beliefs[ghost_position] += belief_distribution[ghost_position] * probability
    ...
    def getBeliefDistribution(self):
        ...
        for particle in self.particles:
            possible_beliefs[particle] += 1

        possible_beliefs.normalize()
        return possible_beliefs
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in self.particles:
            ...
            for ghost_index in range(self.numGhosts):
                evidence *= self.getObservationProb(noisy_distances[ghost_index], pacman_position, particle[ghost_index], self.getJailPosition(ghost_index))
            possible_beliefs[particle] += evidence
